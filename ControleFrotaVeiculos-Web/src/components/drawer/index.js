                ...
                <View style={styles.contentMenu}>
                    ...
                    <ScrollView>
                        ...
                        <TouchableOpacity onPress={() => global.alert.alert('Em desenvolvimento.')} style={styles.btnMenu}>
                            ...
                            <Image source={require('../../assets/icons/home_branca.png')} style={{width:24, height:24}} />
                            </View>
                        ...
                        <TouchableOpacity onPress={() => Actions.veiculos()}>
                            ...
                            <View style={styles.btnMenu}>
                                ...
                                <Image source={require('../../assets/icons/car.png')} style={{width:24, height:24}} />
                        ...
                        <TouchableOpacity onPress={() => global.alert.alert('Em desenvolvimento.')}>
                            ...
                            <View style={styles.btnMenu}>
                                ...
                                <Image source={require('../../assets/icons/idcard.png')} style={{width:24, height:24}} />
                                </View>
                        ...
                        <TouchableOpacity onPress={() => global.alert.alert('Em desenvolvimento.')}>
                            ...
                            <View style={styles.btnMenu}>
                                ...
                                <Image source={require('../../assets/icons/plane.png')} style={{width:24, height:24}} />
                                </View>
                        ...
                        <TouchableOpacity onPress={() => global.alert.alert('Em desenvolvimento.')}>
                            ...
                            <View style={styles.btnMenu}>
                                ...
                                <Image source={require('../../assets/icons/analysis.png')} style={{ width: 24, height: 24 }} />
                                </View>
